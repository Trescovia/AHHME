...
colnames(inputs_general) <- c("parameter", "description", "HIC", "MIC", "", "LIC", "Value", "Min", "Lo", "Med", "Hi", "Max", 
...
scenario_analysis_MIC <- scenario_analysis_LIC
...
scenario_farm_effect       <- "min"
scenario_analysis_MIC[1,1] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "lo"
scenario_analysis_MIC[1,2] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "med"
scenario_analysis_MIC[1,3] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "hi"
scenario_analysis_MIC[1,4] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "max"
scenario_analysis_MIC[1,5] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

scenario_transmission <- "med"

scenario_farm_effect       <- "min"
scenario_analysis_MIC[2,1] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "lo"
scenario_analysis_MIC[2,2] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "med"
scenario_analysis_MIC[2,3] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "hi"
scenario_analysis_MIC[2,4] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "max"
scenario_analysis_MIC[2,5] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

scenario_transmission <- "hi"

scenario_farm_effect       <- "min"
scenario_analysis_MIC[3,1] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "lo"
scenario_analysis_MIC[3,2] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "med"
scenario_analysis_MIC[3,3] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "hi"
scenario_analysis_MIC[3,4] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "max"
scenario_analysis_MIC[3,5] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

scenario_transmission <- "max"

scenario_farm_effect       <- "min"
scenario_analysis_MIC[4,1] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "lo"
scenario_analysis_MIC[4,2] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "med"
scenario_analysis_MIC[4,3] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "hi"
scenario_analysis_MIC[4,4] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
scenario_farm_effect       <- "max"
scenario_analysis_MIC[4,5] <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])
...
tableA <- as.data.frame(rbind(scenario_analysis_LIC, scenario_analysis_MIC, scenario_analysis_HIC))
colnames(tableA) <- c(-2,-1,0,1,2)
tableA$income_group <- c(rep(c("LIC","MIC","HIC"),each = nrow(scenario_analysis_LIC)))
...
write.xlsx(scenario_analysis_MIC, "Outputs/Table 1 B.xlsx")
write.xlsx(scenario_analysis_HIC, "Outputs/Table 1 C.xlsx")
...
colnames(inputs_MIC) <- c("parameter", "description", "HIC", "MIC", "", "LIC", "Value", "Min", "Lo", "Med", "Hi", "Max", 
                          "LIC min", "LIC max", "MIC min", "MIC max", "HIC min", "HIC max",
                          "Distribution", "LIC param 1", "LIC param 2", "MIC param 1", "MIC param 2",
                          "HIC param 1", "HIC param 2")
...
MIC_base <- as.numeric(Model(inputs_general, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

#human AMR effect
inputs_tornado <- inputs_general

inputs_tornado[21,10] <- inputs_tornado[21,15]
MIC_human_AMR_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[21,10] <- inputs_tornado[21,16]
MIC_human_AMR_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_AMR_low <- min((MIC_human_AMR_low - MIC_base), (MIC_human_AMR_high - MIC_base))
MIC_human_AMR_high <- max((MIC_human_AMR_low - MIC_base), (MIC_human_AMR_high - MIC_base))

#discount rate
inputs_tornado <- inputs_general

inputs_tornado[3,4] <- inputs_tornado[3,15]
MIC_human_dr_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[3,4] <- inputs_tornado[3,16]
MIC_human_dr_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_dr_low <- max((MIC_human_dr_low - MIC_base), (MIC_human_dr_high - MIC_base))
MIC_human_dr_high <- min((MIC_human_dr_low - MIC_base), (MIC_human_dr_high - MIC_base))

#AMR growth
inputs_tornado <- inputs_general

inputs_tornado[38,4] <- inputs_tornado[38,15]
MIC_human_amrgro_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[38,4] <- inputs_tornado[38,16]
MIC_human_amrgro_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_amrgro_low <- min((MIC_human_amrgro_low - MIC_base), (MIC_human_amrgro_high - MIC_base))
MIC_human_amrgro_high <- max((MIC_human_amrgro_low - MIC_base), (MIC_human_amrgro_high - MIC_base))

#background AMR
inputs_tornado <- inputs_general

inputs_tornado[28,4] <- inputs_tornado[28,15]
MIC_human_amrbase_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[28,4] <- inputs_tornado[28,16]
MIC_human_amrbase_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_amrbase_low <- min((MIC_human_amrbase_low - MIC_base), (MIC_human_amrbase_high - MIC_base))
MIC_human_amrbase_high <- max((MIC_human_amrbase_low - MIC_base), (MIC_human_amrbase_high - MIC_base))

#WTP
inputs_tornado <- inputs_general

inputs_tornado[6,4] <- inputs_tornado[6,15]
MIC_human_wtp_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[6,4] <- inputs_tornado[6,16]
MIC_human_wtp_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_wtp_low <- min((MIC_human_wtp_low - MIC_base), (MIC_human_wtp_high - MIC_base))
MIC_human_wtp_high <- max((MIC_human_wtp_low - MIC_base), (MIC_human_wtp_high - MIC_base))

#LFPR
inputs_tornado <- inputs_general

inputs_tornado[10,4] <- inputs_tornado[10,15]
MIC_human_lfpr_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[10,4] <- inputs_tornado[10,16]
MIC_human_lfpr_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_lfpr_low <- min((MIC_human_lfpr_low - MIC_base), (MIC_human_lfpr_high - MIC_base))
MIC_human_lfpr_high <- max((MIC_human_lfpr_low - MIC_base), (MIC_human_lfpr_high - MIC_base))

#disease incidence
inputs_tornado <- inputs_general

inputs_tornado[27,4] <- inputs_tornado[27,15]
MIC_human_disease_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[27,4] <- inputs_tornado[27,16]
MIC_human_disease_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_human_disease_low <- min((MIC_human_disease_low - MIC_base), (MIC_human_disease_high - MIC_base))
MIC_human_disease_high <- max((MIC_human_disease_low - MIC_base), (MIC_human_disease_high - MIC_base))
...
MIC_animal_piginc_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[15,11] <- inputs_tornado[15,16]
MIC_animal_piginc_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_piginc_low <- min((MIC_animal_piginc_low - MIC_base), (MIC_animal_piginc_high - MIC_base))
MIC_animal_piginc_high <- max((MIC_animal_piginc_low - MIC_base), (MIC_animal_piginc_high - MIC_base))

#chicken income effect
inputs_tornado <- inputs_general

inputs_tornado[17,11] <- inputs_tornado[17,15]
MIC_animal_chickinc_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[17,11] <- inputs_tornado[17,16]
MIC_animal_chickinc_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_chickinc_low <- min((MIC_animal_chickinc_low - MIC_base), (MIC_animal_chickinc_high - MIC_base))
MIC_animal_chickinc_high <- max((MIC_animal_chickinc_low - MIC_base), (MIC_animal_chickinc_high - MIC_base))

#farm size (pig - I)
inputs_tornado <- inputs_general

inputs_tornado[46,4] <- inputs_tornado[46,15]
MIC_animal_pigfarmi_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[46,4] <- inputs_tornado[46,16]
MIC_animal_pigfarmi_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_pigfarmi_low <- min((MIC_animal_pigfarmi_low - MIC_base), (MIC_animal_pigfarmi_high - MIC_base))
MIC_animal_pigfarmi_high <- max((MIC_animal_pigfarmi_low - MIC_base), (MIC_animal_pigfarmi_high - MIC_base))

#farm size (pig - S)
inputs_tornado <- inputs_general

inputs_tornado[47,4] <- inputs_tornado[47,15]
MIC_animal_pigfarms_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[47,4] <- inputs_tornado[47,16]
MIC_animal_pigfarms_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_pigfarms_low <- min((MIC_animal_pigfarms_low - MIC_base), (MIC_animal_pigfarms_high - MIC_base))
MIC_animal_pigfarms_high <- max((MIC_animal_pigfarms_low - MIC_base), (MIC_animal_pigfarms_high - MIC_base))

#farm size (chicken - I)
inputs_tornado <- inputs_general

inputs_tornado[44,4] <- inputs_tornado[44,15]
MIC_animal_chickfarmi_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[44,4] <- inputs_tornado[44,16]
MIC_animal_chickfarmi_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_chickfarmi_low <- min((MIC_animal_chickfarmi_low - MIC_base), (MIC_animal_chickfarmi_high - MIC_base))
MIC_animal_chickfarmi_high <- max((MIC_animal_chickfarmi_low - MIC_base), (MIC_animal_chickfarmi_high - MIC_base))

#farm size (chicken - S)
inputs_tornado <- inputs_general

inputs_tornado[45,4] <- inputs_tornado[45,15]
MIC_animal_chickfarms_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[45,4] <- inputs_tornado[45,16]
MIC_animal_chickfarms_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_chickfarms_low <- min((MIC_animal_chickfarms_low - MIC_base), (MIC_animal_chickfarms_high - MIC_base))
MIC_animal_chickfarms_high <- max((MIC_animal_chickfarms_low - MIC_base), (MIC_animal_chickfarms_high - MIC_base))

#number of pigs
inputs_tornado <- inputs_general

inputs_tornado[42,4] <- inputs_tornado[42,15]
MIC_animal_npigs_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[42,4] <- inputs_tornado[42,16]
MIC_animal_npigs_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_npigs_low <- min((MIC_animal_npigs_low - MIC_base), (MIC_animal_npigs_high - MIC_base))
MIC_animal_npigs_high <- max((MIC_animal_npigs_low - MIC_base), (MIC_animal_npigs_high - MIC_base))

#number of chickens
inputs_tornado <- inputs_general

inputs_tornado[43,4] <- inputs_tornado[43,15]
MIC_animal_nchicks_low <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

inputs_tornado[43,4] <- inputs_tornado[43,16]
MIC_animal_nchicks_high <- as.numeric(Model(inputs_tornado, scenario_income, scenario_prod, scenario_transmission,scenario_farm_effect)[1,1])

MIC_animal_nchicks_low <- min((MIC_animal_nchicks_low - MIC_base), (MIC_animal_nchicks_high - MIC_base))
MIC_animal_nchicks_high <- max((MIC_animal_nchicks_low - MIC_base), (MIC_animal_nchicks_high - MIC_base))
...
tornado_MIC_human <- data.frame(variable = c("Effect on Human AMR",
                                              "Discount Rate",
                                              "Growth Rate of AMR",
                                              "Baseline AMR prevalence",
                                              "Willingness to Pay per QALY",
                                              "Labour Force Participation Rate",
                                              "Infection Prevalence"),
                                 min = c(MIC_human_AMR_low,
                                         MIC_human_dr_low,
                                         MIC_human_amrgro_low,
                                         MIC_human_amrbase_low,
                                         MIC_human_wtp_low,
                                         MIC_human_lfpr_low,
                                         MIC_human_disease_low),
                                 max = c(MIC_human_AMR_high,
                                         MIC_human_dr_high,
                                         MIC_human_amrgro_high,
                                         MIC_human_amrbase_high,
                                         MIC_human_wtp_high,
                                         MIC_human_lfpr_high,
                                         MIC_human_disease_high))


#MICI - Animal

tornado_MIC_animal <- data.frame(variable = c("Effect on Pig Productivity",
                                               "Effect on Chicken Productivity",
                                               "Size of Industrial Pig Farms",
                                               "Size of Smallholder Pig Farms",
                                               "Size of Industrial Chicken Farms",
                                               ...
                                               "Number of Pigs",
                                               "Number of Chickens"),
                                  min = c(MIC_animal_piginc_low,
                                          MIC_animal_chickinc_low,
                                          MIC_animal_pigfarmi_low,
                                          MIC_animal_pigfarms_low,
                                          MIC_animal_chickfarmi_low,
                                          MIC_animal_chickfarms_low,
                                          MIC_animal_npigs_low,
                                          MIC_animal_nchicks_low),
                                  max = c(MIC_animal_piginc_high,
                                          MIC_animal_chickinc_high,
                                          MIC_animal_pigfarmi_high,
                                          MIC_animal_pigfarms_high,
                                          MIC_animal_chickfarmi_high,
                                          MIC_animal_chickfarms_high,
                                          MIC_animal_npigs_high,
                                          MIC_animal_nchicks_high))
...
tornado_MIC_animal$ic <- "MIC"
tornado_MIC_animal$sp <- "animal"
tornado_MIC_human$ic <- "MIC"
tornado_MIC_human$sp <- "human"
...
fig3_data_orig <- rbind(tornado_HIC_animal, tornado_HIC_human,
                   tornado_MIC_animal, tornado_MIC_human,
