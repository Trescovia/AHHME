# Function for evaluating health states -----------------------------------
...
f_animal_epi <- function(inputs, m_param_a_base, n.t, scenario_animal){
  
  n.t <- inputs[parameter == "n.t", Value]
...
Model <- function(inputs, scenario_income, scenario_prod, scenario_transmission,
  ...
  m_param_c_s <- f_animal_epi(inputs, m_param_c_s_base,n.t, scenario_animal)
  ...
  m_param_c_i <- f_animal_epi(inputs, m_param_c_i_base,n.t, scenario_animal)
  ### ignore totals of transition probs etc. as they are over counted etc.
  ## just want to focus on health state totals
  ...
  m_param_p_s <- f_animal_epi(inputs, m_param_p_s_base,n.t, scenario_animal)
  ### ignore totals of transition probs etc. as they are over counted etc.
  ## just want to focus on health state totals
  ...
  m_param_p_i <- f_animal_epi(inputs, m_param_p_i_base,n.t, scenario_animal)
  ### ignore totals of transition probs etc. as they are over counted etc.
  ## just want to focus on health state totals  
  ...
  scenario_animal <- "chicken_ind"
  m_param_c_i2 <- f_animal_epi(inputs, m_param_c_i2, n.t, scenario_animal)
  ...
  #apply the animal epi function
  scenario_animal <- "chicken_small"
  m_param_c_s2 <- f_animal_epi(inputs, m_param_c_s2, n.t, scenario_animal)
  ...
  #apply the animal epi function
  scenario_animal <- "pig_ind"
  m_param_p_i2 <- f_animal_epi(inputs, m_param_p_i2, n.t, scenario_animal)  
  ...
  #apply the animal epi function
  scenario_animal <- "pig_small"
  m_param_p_s2 <- f_animal_epi(inputs, m_param_p_s2, n.t, scenario_animal)
